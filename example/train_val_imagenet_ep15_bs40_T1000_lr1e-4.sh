...
python3 Main.py \
    ...
    use_multi_gpu=true \
    device=cuda \
    save_weight_dir="./Checkpoints/ep15_bs40_T1000_lr1e-4" \
    metrics_save_dir="./metrics_curves/ep15_bs40_T1000_lr1e-4" \
    sampled_dir="./SampledImgs/ep15_bs40_T1000_lr1e-4" \
